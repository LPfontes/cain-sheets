...
export function resetDiceDrawerSelections() {
  ...
  if (el.diceQtyD6) el.diceQtyD6.textContent = 0;
  if (el.diceQtyD10) el.diceQtyD10.textContent = 0;
  if (el.diceQtyD12) el.diceQtyD12.textContent = 0;
  if (el.currentRollLabel) el.currentRollLabel.textContent = "Nenhuma aptidão selecionada na ficha";
  if (el.modEmpenho) el.modEmpenho.checked = false;
  if (el.modOrigemOcupacao) el.modOrigemOcupacao.checked = false;
  if (el.modOrigemEvento) el.modOrigemEvento.checked = false;
